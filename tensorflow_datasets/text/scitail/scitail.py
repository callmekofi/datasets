  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    return [
        tfds.core.SplitGenerator(
            ...
            gen_kwargs={
                'filepath':
                    data_dir / _SCITAIL_DIR / _TSV_DIR / 'scitail_1.0_train.tsv'
            },
        ),
        tfds.core.SplitGenerator(
            ...
            gen_kwargs={
                'filepath':
                    data_dir / _SCITAIL_DIR / _TSV_DIR / 'scitail_1.0_dev.tsv'
            },
        ),
        tfds.core.SplitGenerator(
            ...
            gen_kwargs={
                'filepath':
                    data_dir / _SCITAIL_DIR / _TSV_DIR / 'scitail_1.0_test.tsv'
            },
        ),
    ]
